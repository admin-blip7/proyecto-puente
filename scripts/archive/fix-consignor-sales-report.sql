-- Comprehensive fix for consignor sales report API
...
SELECT 
    ...
    (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'consignors' AND table_schema = 'public') as column_count
UNION ALL
SELECT 
    'sales' as table_name,
    (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'sales' AND table_schema = 'public') as column_count
UNION ALL
SELECT 
    'clients' as table_name,
    (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'clients' AND table_schema = 'public') as column_count
UNION ALL
SELECT 
    'cash_sessions' as table_name,
    (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'cash_sessions' AND table_schema = 'public') as column_count;
