// Script corregido para solucionar problemas de balances de consignadores
...
console.log('🔧 Solucionando Problemas de Balances de Consignadores (Corregido)');
console.log('==================================================================\n');

async function fixConsignorBalancesCorrected() {
  try {
    ...
    // 3. Obtener todas las ventas (usando createdAt en lugar de created_at)
...
fixConsignorBalancesCorrected().then(() => {
  console.log('\n🏁 Script finalizado');
  process.exit(0);
}).catch(error => {
