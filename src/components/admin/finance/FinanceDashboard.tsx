...
const calculateMetrics = (
    ...
    const salesInRange = safeSales.filter(sale => isWithinInterval(sale.createdAt, range));
    const expensesInRange = safeExpenses.filter(expense => isWithinInterval(expense.paymentDate, range));
    const repairsInRange = safeRepairs.filter(repair => repair.completedAt && isWithinInterval(repair.completedAt, range));
    ...
    const lowRotationProducts = safeProducts
