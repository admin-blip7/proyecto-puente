...
export default async function WholesalePage() {
  // Obtener pedidos pendientes y recientes
                  ...
                  {orders.length === 0 ? (
                    ...
                    orders.map((order) => (
                      <tr key={order.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3">
                          <span
                            className={`inline-flex px-2 py-1 rounded text-xs font-medium border ${statusColors[order.status]}`}
                          >
                        ...
                        <td className="px-4 py-3 text-right">
                          <Button asChild variant="ghost" size="sm">
                            <Link href={`/admin/wholesale/orders/${order.id}`}>
                              Ver
                            </Link>
                          </Button>
                        </td>
