-- ===================================
-- CRM Module Repair Migration
-- Creates missing CRM tables and fixes failed migrations
-- ===================================

-- Create or replace the update_updated_at_column function (required by CRM tables)
...
-- Create crm_clients table if it doesn't exist
