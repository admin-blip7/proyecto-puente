...
-- Políticas RLS
CREATE POLICY "Enable all for authenticated" ON crm_clients FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Enable all for authenticated" ON crm_interactions FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Enable all for authenticated" ON crm_tags FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Enable all for authenticated" ON crm_tasks FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Enable all for authenticated" ON crm_documents FOR ALL USING (auth.role() = 'authenticated');
